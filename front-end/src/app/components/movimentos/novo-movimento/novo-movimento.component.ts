...
@Component({
  selector: 'app-novo-movimento',
  templateUrl: './novo-movimento.component.html',
  styleUrls: ['./novo-movimento.component.scss']
})
export class NovoMovimentoComponent implements OnInit {
  ...
  salvar() {
    ...
    this._movimentoService.adicionarMovimento(this.movimento)
      .subscribe(data => {
        if (data.mensagem) {
